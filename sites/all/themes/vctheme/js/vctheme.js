    ...
    attach: function (context, settings) {
      ...
      function checkPhoto() {
        if ($(".field-name-field-user-photo .file-upload-content img").is("img")) {
          ...
          if (src) {
            $(".p-card-photo").html("<div><img src=\"" + src + "\" /></div>");
          }
      ...
      function checkLogo() {
        if ($(".field-name-field-company-logo .file-upload-content img").is("img")) {
          ...
          if (src) {
            $(".p-card-logo").html("<div><img src=\"" + src + "\" /></div>");
          }
          else {
        ...
        if (navigator.userAgent.match(/YaBrowser/i)) {
          ...
          if (navigator.userAgent.match(/Mobile Safari/i)) {
            ...
            if (navigator.userAgent.match(/iPhone|iPad/i)) {
              ...
              $(".popover-inner-content").html("Для добавления иконки быстрого доступа на экран устройства нажмите \"Поделиться\" , а затем \"Добавить на Главный экран\"");
            }
          }
        }
